...
import HeroLogo from "@/app/animations/HeroLogo";
      ...
      <section className="flex flex-col mx-8 mt-16">
        <Appear>
          ...
          <div className="mx-auto w-full flex flex-col justify-center items-center lg:flex-row lg:justify-start lg:gap-4">
            <button className=" z-10 w-full cursor-pointer max-w-[343px] bg-blue-400 text-white h-16 rounded-3xl font-semibold text-lg mb-4 hover:bg-blue-500 lg:w-auto lg:px-8 lg:py-4">
              Get Started
            </button>

            <button className="z-10 flex cursor-pointer items-center justify-center align-middle w-full max-w-[343px] bg-gray-100 text-black font-semibold  h-16 rounded-3xl font-lg text-lg mb-4 hover:bg-gray-300  lg:w-auto lg:px-8 lg:py-4">
