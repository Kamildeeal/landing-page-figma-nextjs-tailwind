...
import { navbarDesktop } from "@/app/animations/helper/NavbarAnimations";
import HamburgerMenuItem from "@/app/animations/HamburgerMenuItem";
        ...
        <section>
          ...
          {isOpen && (
            <div
              ...
              className="overflow-hidden justify-center absolute top-0 left-0 w-full h-full z-20 bg-black bg-opacity-80"
            >
          ...
          <div className="hidden sm:flex">
            <motion.ul
              className="flex flex-row mt-8 gap-10 text-base font-medium lg:text-xl"
              animate="visible"
              initial="hidden"
              variants={navbarDesktop}
            >
